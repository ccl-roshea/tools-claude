...
- [ ] **Cross-session resume.** Currently a session that hits its budget and stops loses state. Worth building when sessions become long enough that this is annoying.
